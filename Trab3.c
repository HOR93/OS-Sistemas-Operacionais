...
int main(){
  ...
  int Fila_Processos[100], proximo_a_executar = 0, proximo_a_adicionar = 0;// Fila de processos e variaveis dos futuros processos
  ...
  while (t < tmax || Processo_em_execucao != -1 || proximo_a_executar < proximo_a_adicionar){
    if(Processo_em_execucao != -1){ // SE ainda tem processo no momento
      if (tempo[Processo_em_execucao] == 0){ // se o processo terminou
        Tempo_Conclusao[Processo_em_execucao] = t; //então armazena o tempo de cada processo no simulador e salva o tempo atual com da conclusão
...
//#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-
  ...
  for (int i = 0; i< N_Processos; i++) {
      Tempo_TOTAL_retorno+= Tempo_Conclusao[i] - Data[i]; // pro turnaround vai ser feit a soma o tempo total de conclusão dos processos - tempo de criação de cada processo
  }

    int Media_Retorno= Tempo_TOTAL_retorno / N_Processos; // media
